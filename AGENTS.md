...
当前仓库原始上游是 [bin456789/reinstall](https://github.com/bin456789/reinstall)
...
- 2026-06-18：同步上游 [bin456789/reinstall](https://github.com/bin456789/reinstall) 最新变动（至 `1a76b4f`），重新应用所有 fork 补丁；README 中为 `bin456789/reinstall` 添加 GitHub 超链接；额外清理 `ttys.sh`、`windows-setup.bat` 中残留的上游 issue 注释链接。
