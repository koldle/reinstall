...
本仓库基于 [bin456789/reinstall](https://github.com/bin456789/reinstall) 做了 NixOS Big EFI 特化，当前主要维护以下变动：
...
```bash
bash reinstall.sh nixos 26.05
```

```bash
NIXOS_EFI_SIZE_MB=1024 bash reinstall.sh nixos 26.05
```
