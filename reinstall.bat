...
set confhome=https://raw.githubusercontent.com/koldle/reinstall/main
set confhome_cn=https://ghfast.top/https://raw.githubusercontent.com/koldle/reinstall/main
